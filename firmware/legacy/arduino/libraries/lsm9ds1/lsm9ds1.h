...
/* by the lsm9ds1::Sensor class to read and retrieve individual sensors. */
typedef void (lsm9ds1::*lsm9ds1_read_func)(void);
typedef void (lsm9ds1::*lsm9ds1_get_event_func)(sensors_event_t*, uint32_t);
typedef void (lsm9ds1::*lsm9ds1_get_sensor_func)(sensor_t*);

class lsm9ds1
{
  public:
    lsm9ds1 ( int32_t sensorID = 0 );
    lsm9ds1 ( TwoWire* wireBus, int32_t sensorID = 0 );
    ...
    bool getEvent  ( sensors_event_t* mag, sensors_event_t* gyro );    
    void getSensor ( sensor_t* mag, sensor_t* gyro );
    ...
    public:
      ...
      {}
      Sensor(lsm9ds1* parent, lsm9ds1_read_func readFunc, 
