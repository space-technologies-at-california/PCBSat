...
static const uint8_t TWISDA0  = 10; /* P1.3 */
static const uint8_t TWISCL0  = 11; /* P1.2 */
static const uint8_t DEBUG_UARTRXD = 5;  /* Receive  Data (RXD) at P1.6 */
static const uint8_t DEBUG_UARTTXD = 6;  /* Transmit Data (TXD) at P1.5 */
#define TWISDA0_SET_MODE  (PORT_SELECTION0 | PORT_SELECTION1 | INPUT_PULLUP)
